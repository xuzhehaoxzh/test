...
function get(parameter,element){
	ajax('get','https://study.163.com/webDev/couresByCategory.htm',parameter,function(adata){
...
function getPages(parameter,element,element1){
	ajax('get','https://study.163.com/webDev/couresByCategory.htm',parameter,function(pagesNum){
...
function getranking(){
	ajax('get','https://study.163.com/webDev/hotcouresByCategory.htm','',function(rank){
...
LoginBtn.onclick=function(){
	...
	ajax('get','https://study.163.com/webDev/login.htm','userName='+Username+'&password='+Password,function(a){
		if(a==='1'){
			oMask.style.display='none';
			oLogin.style.display='none';
